...
export default function RegrasVenda() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <form onSubmit={salvar} className="space-y-4 rounded-lg border border-slate-200 bg-white p-5">
        <div>
          <label className="mb-1 block text-sm font-medium text-slate-700">Palavras/frases-gatilho</label>
          <textarea
            value={palavrasChave}
